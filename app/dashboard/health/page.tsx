...
const HealthCharts = nextDynamic(() => import('@/components/health/health-charts'), { ssr: false });
...
export default function HealthPage() {
  ...
  return (
    <div className="container mx-auto space-y-6">
      ...
      <HealthCharts cpuData={cpuData} memoryData={memoryData} storageData={storageData} />

    ...
    <section className="py-12 sm:py-16 bg-[#111317] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          <div className="inline-flex items-center space-x-2 px-3 py-0.5 rounded-full border border-white/15 bg-white/5 text-slate-300 text-xs font-mono">
            <ShieldAlert className="w-3.5 h-3.5 text-[#ff3538]" />
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#161820]/90 p-5 sm:p-6 backdrop-blur-xl shadow-xl hover:border-white/20 transition-all flex flex-col justify-between group space-y-4">
              ...
              <div className="bg-[#0c0d10] border border-white/10 rounded-xl p-3 relative overflow-hidden font-mono text-[9px] space-y-2">
                ...
                {/* Simulated CCTV Frame with Intrusion Bounding Box */}
              ...
              <div className="bg-[#0c0d10] border border-white/10 rounded-xl p-3 relative overflow-hidden font-mono text-[9px] space-y-2">
                ...
                <div className="relative h-24 rounded bg-slate-900/80 border border-slate-800 p-2 flex flex-col justify-between">
                  ...
                  <div className="relative w-full h-6 flex items-center justify-between px-3">
                    <div className="absolute inset-x-3 top-1/2 h-0.5 bg-gradient-to-r from-slate-700 via-white/50 to-[#ff3538]" />
            ...
            <div className="rounded-2xl border border-white/10 bg-[#161820]/90 p-5 sm:p-6 backdrop-blur-xl shadow-xl hover:border-white/20 transition-all flex flex-col justify-between group space-y-4">
              ...
              <div className="bg-[#0c0d10] border border-white/10 rounded-xl p-2.5 relative overflow-hidden font-mono text-[9px] space-y-2">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  ...
                  <div className="bg-slate-900 border border-white/10 rounded p-1.5 space-y-0.5">
                    <div className="flex items-center justify-between">
                      <span className="text-white font-bold text-[8px]">CAM 01</span>
                  ...
                  <div className="bg-slate-900 border border-white/10 rounded p-1.5 space-y-0.5">
                    <div className="flex items-center justify-between">
                      <span className="text-white font-bold text-[8px]">CAM 02</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                    </div>
                    <span className="text-[7.5px] text-slate-300 block font-bold">LIVE (100%)</span>
                  </div>
                  ...
                  <div className="bg-slate-900 border border-white/10 rounded p-1.5 space-y-0.5">
                    <div className="flex items-center justify-between">
                      <span className="text-white font-bold text-[8px]">CAM 03</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                    </div>
                    <span className="text-[7.5px] text-slate-300 block font-bold">LIVE (100%)</span>
                  </div>
                  ...
                  <div className="bg-slate-900 border border-white/10 rounded p-1.5 space-y-0.5">
                    <div className="flex items-center justify-between">
                      <span className="text-white font-bold text-[8px]">CAM 04</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                    </div>
                    <span className="text-[7.5px] text-slate-300 block font-bold">LIVE (100%)</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-5">
            ...
            <div className="md:col-span-2 rounded-2xl border border-white/10 bg-[#161820]/90 p-5 sm:p-6 backdrop-blur-xl shadow-xl hover:border-white/20 transition-all flex flex-col justify-between group space-y-4">
            ...
            <div className="md:col-span-3 rounded-2xl border border-white/10 bg-[#161820]/90 p-5 sm:p-6 backdrop-blur-xl shadow-xl hover:border-white/20 transition-all flex flex-col justify-between group space-y-4">
              ...
              <div className="bg-[#0c0d10] border border-white/10 rounded-xl p-3.5 relative overflow-hidden font-mono text-[10px] space-y-3">
                ...
                {/* Cameras Connection Flow Header */}
                ...
                <div className="relative py-2 px-1">
                  ...
                  <div className="absolute top-6 inset-x-6 h-0.5 bg-gradient-to-r from-slate-700 via-slate-400 to-[#ff3538] rounded-full" />

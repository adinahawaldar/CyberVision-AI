                ...
                return (
                  ...
                  >
                    <div className="relative mb-4">
                      ...
                      <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#151722]/90 border border-white/10 ${step.accent} shadow-xl flex items-center justify-center backdrop-blur-xl relative`}>
                        {/* Static Orbit Border Ring */}
                        <div className="absolute inset-0 rounded-full border border-cyan-400/20 opacity-50" />

                        {/* Minimal Inner Icon Badge */}
                        <div className={`p-2 sm:p-2.5 rounded-xl border ${step.iconBg}`}>
              ...
              {stepsRow2.map((step, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    whileInView={{ opacity: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: (4 + idx) * 0.08 }}
                    className="flex flex-col items-center text-center group"
                  >
                    <div className="relative mb-4">
                      {/* Minimal Number Badge */}
                      ...
                      <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#151722]/90 border border-white/10 ${step.accent} shadow-xl flex items-center justify-center backdrop-blur-xl relative`}>
                        {/* Static Orbit Border Ring */}
                        <div className="absolute inset-0 rounded-full border border-red-400/20 opacity-50" />
